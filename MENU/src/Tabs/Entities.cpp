...
void Entities::Draw() 
{
    ...
    //  }
    //  
    //  if (ImGui::Button("KILL ALL ENTITIES", ImVec2(ImGui::GetContentRegionAvail().x, 20))) {
    ...
    //  if (ImGui::Button("FREEZE ALL ENTITIES", ImVec2(ImGui::GetContentRegionAvail().x, 20))) {
    ...
    //  ImGui::Spacing();
    //  
    //  if (ImGui::Button("TELEPORT ALL TO CROSSHAIR", ImVec2(ImGui::GetContentRegionAvail().x, 20))) {
